...
document.addEventListener('DOMContentLoaded', async () => {
    // This check ensures Firebase is initialized before we use it
    if (typeof firebase === 'undefined') {
        console.error("Firebase is not loaded. Make sure firebase-config.js is included before this script.");
        return;
    }
    ...
    try {
        ...
        if(blogGrid) blogGrid.innerHTML = ''; // Clear loader/default text
